// =============================================================================
//  @virtual-grid/core — useRowSelection
//
...
//
//  Intentionally decoupled from VirtualGrid so consumers can wire it in
//  any way they like (checkbox column, row click, keyboard, etc.).
//
//  Usage:
//    const selection = useRowSelection({ data, getRowId });
//    <VirtualGrid onRowClick={(row, i, e) => selection.handleRowClick(row, i, e)} />
// =============================================================================
