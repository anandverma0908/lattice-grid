// =============================================================================
//  @virtual-grid/core — useColumnDrag  (pointer-event based reorder)
//
//  Performance design:
...
//
//  No DOM registry:
//    • getColumnViewportBounds() is provided by the caller (VirtualGrid) and
...
export interface UseColumnDragOptions {
   ...
   * Computed mathematically in VirtualGrid so it works for ALL columns,
