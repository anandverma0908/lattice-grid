  ...
  return (
    <div
      style={{
        ...
        gap: 8,
        padding: "5px 0",
        borderBottom: `1px solid ${isDark ? "#1e2840" : "#f3f4f6"}`,
      }}
    >
      <span
        style={{
...
export default function App() {
  ...
  const [colPanelPosition, setColPanelPosition] = useState<
    "sidebar" | "floating" | "bottom"
  >("sidebar");
  ...
  const [features, setFeatures] = useState({
    ...
    columnPin: true,
    alternateRows: true,
    toolbar: false, // we use a custom toolbar via slot
          ...
          <div style={{ display: "flex", flex: 1, overflow: "hidden" }}>
            ...
            >
              ...
              {activePanel === "columns" && (
                ...
                >
                  <span style={{ color: dimClr, fontWeight: 500 }}>
                  ...
                  <div style={{ flex: 1, overflow: "auto" }}>
                    ...
                    <div style={{ padding: "8px 16px" }}>
                      ...
                      <TokenRow
                        label="--vg-accent"
                        tokenKey="--vg-accent"
                        value={getToken("--vg-accent")}
                        onChange={setToken}
                        isDark={isDark}
                      />
                      <TokenRow
                        label="--vg-accent-bg"
                        tokenKey="--vg-accent-bg"
                        value={getToken("--vg-accent-bg")}
                        onChange={setToken}
                        isDark={isDark}
                      />
                      <TokenRow
                        label="--vg-bg"
                        tokenKey="--vg-bg"
                        value={getToken("--vg-bg")}
                        onChange={setToken}
                        isDark={isDark}
                      />
                      <TokenRow
                        label="--vg-bg-header"
                        tokenKey="--vg-bg-header"
                        value={getToken("--vg-bg-header")}
                        onChange={setToken}
                        isDark={isDark}
                      />
                      <TokenRow
                        label="--vg-bg-row-hover"
                        tokenKey="--vg-bg-row-hover"
                        value={getToken("--vg-bg-row-hover")}
                        onChange={setToken}
                        isDark={isDark}
                      />
                      <TokenRow
                        label="--vg-bg-row-selected"
                        tokenKey="--vg-bg-row-selected"
                        value={getToken("--vg-bg-row-selected")}
                        onChange={setToken}
                        isDark={isDark}
                      />
                      <TokenRow
                      ...
                      <TokenRow
                        label="--vg-font-size"
                        tokenKey="--vg-font-size"
                        value={getToken("--vg-font-size")}
                        onChange={setToken}
                        type="text"
                        isDark={isDark}
                      />
                ...
                {activePanel === "features" && (
                  <div style={{ flex: 1, overflow: "auto" }}>
                    ...
                    >
                      ...
                      >
                        Note: toolbar and footer are managed by custom slots in
                        this demo. Toggle them here to see the slot vs built-in
                        difference.
                      </div>
                    </div>
                  </div>
