...
const DCS = [
  'Ahmedabad','Bangalore','Gr.Noida','Guwahati','Hyderabad',
  'Kolkata','Lucknow DC','Mohali','Mumbai','Nagpur',
  'Pune','Chennai','Jaipur','Surat','Patna','Bhopal',
];

const STATUSES: InventoryRow['status'][] = ['active','active','active','low','out'];
